...
class AddcategroiesUpdate extends StatefulWidget {
  String title;
  String id;
  AddcategroiesUpdate({this.id, this.title});
  @override
  State<AddcategroiesUpdate> createState() => _AddcategroiesUpdateState();
}

class _AddcategroiesUpdateState extends State<AddcategroiesUpdate> {
  ...
  uploadToFirebase() async {
    ...
    await db.collection("category").doc(widget.id).update({
